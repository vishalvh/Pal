...
class creditdebit_model extends CI_Model
{
   ...
   public function __construct() 
   {
    ...
    $this->db->select('location.l_name,user.UserFName,shi.id,ud.name,shi.date,shi.payment_type,shi.bill_no,shi.vehicle_no,shi.fuel_type,shi.amount,shi.quantity');
