<?php class Stock_patrak_reports_model extends CI_Model {
    ...
    public function report($location,$sdate,$edate){
        ...
        SELECT 
			...
			dr.p_opening_original_stock,
			dr.d_opening_original_stock,
			dr.p_closing_original_stock,
            dr.d_closing_original_stock,
			dr.pshort,
            dr.dshort,
	...
	public function worker_salary_remening($cid,$month,$year,$worker_id = ""){
            $query2 = "SELECT id, code,name,salary,
