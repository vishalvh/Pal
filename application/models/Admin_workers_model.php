...
class admin_workers_model extends CI_Model
{
	var $table = 'sh_workers as shp';
   	var $column_order = array(null, 'shp.name','shp.mobile','shl.l_name','shc.name'); //set column field database for datatable orderable
   var $column_search = array('shp.name','shp.mobile','shl.l_name','shc.name'); //set column field database for datatable searchable
   ...
   public function __construct() 
   {
    ...
    $this->db->select('shp.id,shp.name as pumpname,shp.mobile,shl.l_name,shc.name');
