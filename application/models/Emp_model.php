...
class emp_model extends CI_Model
{
	var $table = 'shusermaster as shr';
   	var $column_order = array(null, 'shr.UserFName','shr.UserEmail','shr.UserMNumber','shl.l_name','shc.name'); //set column field database for datatable orderable
   var $column_search = array('shr.UserFName','shr.UserEmail','shr.UserMNumber','shl.l_name','shc.name'); //set column field database for datatable searchable
   ...
   public function __construct() 
   {
    ...
    $this->db->select('shr.id,shr.UserFName,shr.UserEmail,shr.UserMNumber,shl.l_name,shc.name');
		$this->db->from($this->table);
    $this->db->join('sh_location as shl','shl.l_id = shr.l_id', 'inner');
    $this->db->join('sh_com_registration as shc','shc.id = shr.company_id','inner' );
