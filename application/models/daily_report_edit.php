...
<hr>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" placeholder="Petrol Stock" name="petrolstock" value="<?php echo $Petrol_inventory->p_stock;?>">
									</div>
								</div>
								<div class="form-group">
...
<hr>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" placeholder="Diesel Stock" name="dieselstock" value="<?php echo $diesel_inventory->d_stock;?>">
									</div>
								</div>
								<div class="form-group">
