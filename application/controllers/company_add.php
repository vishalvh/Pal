...
<script src="<?php echo base_url(); ?>plugins/jQuery/jQuery-2.1.4.min.js"></script>
          ...
          <section class="content">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Company/company_insert" method="post" name="savingdata" onsubmit="return validate()" id="savingdata" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    <div class="col-md-6">
                      ...
                      <input type="text" id="companyname"  name="companyname" class="form-control"  value="<?php echo set_value('companyname'); ?>" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="mobile"  name="mobile" class="form-control"  value="<?php echo set_value('mobile'); ?>" >
