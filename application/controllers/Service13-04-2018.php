...
//    }
	function add_inventory()
    {
        ...
        if($token != "" && $pi_number != "" && $p_fuelamount != "" && $pv_taxamount != "" && $p_paymenttype != "" && $p_chequenumber != "" && $p_paidamount != "" && $p_quantity != "" && $p_tankerreading != "" && $di_number != "" && $d_fuelamount != "" && $dv_taxamount != "" && $d_paymenttype != "" && $d_chequenumber != "" && $d_paidamount != "" && $d_quantity != "" && $d_tankerreading != "" && $oil_type != "" && $o_quantity  != "" && $date2 != "")
        {
            $list = $this->service_model->master_fun_get_tbl_val("shadminmaster", array("token" => $token, "status" => 1), array("id", "id"));
