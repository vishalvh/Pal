  ...
  $prefs = array( 'format' => 'sql', // gzip, zip, txt 
    ...
    public function user_list(){
        ...
        if ($token != "") 
        {
                ...
                if ($list) 
                {
                    $data = $this->service_model->get_user_list($list[0]['company_id']);
					if($data){
                    echo $this->json_data("1", "", $data);
					}else{
...
if($data){
    ...
    public function company_pump()    {
        ...
        if($token != "")
        {
            ...
            if ($list) 
            {
                   $data = $this->service_model->master_fun_get_tbl_val_company_pump("shpump", array("shpump.company_id" =>$company_id ,"shpump.status" => 1), array("id", "asc"));
    ...
    public function company_employee()    {
        ...
        if($token != "")
        {
            ...
            if ($list) 
            {
                   $data = $this->service_model->master_fun_get_tbl_val_company_employee("shusermaster", array("shusermaster.company_id" =>$company_id ,"shusermaster.status" => 1), array("id", "asc"));
				   if($data){
                   echo $this->json_data("1","",$data);
    ...
    public function add_location()    {
        ...
        if ($token != "" && $location_name != "" && $phone_no != "" && $address != "") 
        {
            $list = $this->service_model->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) 
            {
    ...
    public function edit_location()    {
        ...
        if ($token != "" && $location_name != "" && $location_id != "" && $phone_no != "" && $address != "") 
        {
            $list = $this->service_model->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) 
            {
    ...
    public function inventory_report()    {
        ...
        if ($token != "") 
        {
                ...
                if ($list) 
                {
                        ...
                        $data = $this->service_model->master_fun_get_tbl_val_company_inventory_1($user_id,$date_to,$date_from,$current_date,$company_id,$location_id);
                        ;
if($data == null){
    ...
    public function worker_list()    {
        ...
        if($token != "")
        {
            ...
            if ($list) 
            {
                   $data = $this->service_model->company_worker_list($company_id);
