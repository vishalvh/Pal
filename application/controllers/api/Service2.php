...
//              $this->email->to($email.',jabir@virtualheight.com');
	...
	if($token != "" ){
		...
		$data['gst'] = 9;
		$data['oil_benift'] = 5;
		$data['vesion_code'] = $finalarray = array("vesion_code"=>"20","flag"=>"TRUE");
...
if($data){
    ...
    public function dailyprice_report()    {
        ...
        if ($token != "") 
        {
            ...
            {
                $company_id = $list[0]['id'];
                $data = $this->service_model_1->master_fun_get_tbl_val_company_dailyprice($date_to,$date_from,$current_date,$location_id);
    ...
    public function bankdeposit()    {
        ...
        if($token != "" )
        {
            ...
            if ($list) 
            {
                ...
                $data = $this->service_model_1->master_fun_get_tbl_val_company_bankdeposit($date_to,$date_from,$current_date,$location_id);
				//echo $this->db->last_query();
               if($data){
                echo $this->json_data("1","",$data);
				}else{
	...
	public function creditdebit()    {
        ...
        if($token != "")
        {
            ...
            if ($list) 
            {
                ...
                $data = $this->service_model_1->master_fun_get_tbl_val_company_credit_debit($user_id,$date_to,$date_from,$current_date,$location_id);
				//echo $this->db->last_Query();
                 if($data){
