...
class Service13 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('form');
        $this->load->helper('url');
        $this->load->model('Service_model_13');
    ...
    public function Squadli_tarce() {
        ...
        $Squadli_info = $this->Service_model_13->master_insert("alldata", $user_track_data);
        //return true;
    }
    ...
    public function register() {
        ...
        if ($mobile != NULL && $email != null && $password != null && $type != null && $name != null) {
            $row = $this->Service_model_13->master_num_rows("customer_master", array("email" => $email, "status" => 1));
            if ($row == 0) {
                $email = strtolower($email);
                $insert = $this->Service_model_13->master_fun_insert("customer_master", array("name" => $name, "type" => $type, "email" => $email, "password" => $password, "mobile" => $mobile, "active" => '0'));
...
//              $this->email->to($email.',jabir@virtualheight.com');
    ...
    public function verify($id) {
        ...
        $update = $this->Service_model_13->master_fun_update_1("customer_master", $id, $data1);
        echo "thank you your account has been successfully verified";
    }

    public function verify1($id) {
        $data1 = array("active" => '1');
        $update = $this->Service_model_13->master_fun_update("customer_master", $id, $data1);
    }
    ...
    public function login() {
        ...
        if ($email != NULL && $password != NULL) {
            ...
            if ($result != "") {
                $data = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("UserEmail" => $email, "UserPassword" => $password, "status" => 1,"Active"=>1), array("id", "asc"));
                $uniqueId = substr(base_convert(sha1(uniqid(mt_rand())), 16, 36), 0, 8);
                $data1 = array("token" => $uniqueId);
                $Active = $data[0]['Active'];
                $id = $data[0]['id'];
                $update = $this->Service_model_13->master_fun_updateid("shusermaster", $id, $data1);
                if ($Active == '1') {
                    $row = $this->Service_model_13->master_num_rows("shusermaster", array("id" => $data[0]['id'], "status" => 1,"Active"=>1));
                    $locationname = $this->Service_model_13->master_fun_get_tbl_val("sh_location", array("l_id" => $data[0]['l_id'], "status" => 1));
                    $membercount = $this->Service_model_13->master_num_rows("shusermaster", array("id" => $data[0]['id'], "status" => 1 ,"Active"=>1));
                    $data[0]['team_count'] = "$row";
                    $list = array();
                    $list = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("id" => $data[0]['id'], "status" => 1,"Active"=>1), array("id", "id"));
                    $user_team = array();
                    $user_team = $this->Service_model_13->select_all("shusermaster", $id);
                    //echo $this->db->last_query();
                    $petrol = $this->Service_model_13->get_pump_list('P', $data[0]['l_id']);
                    $diesel = $this->Service_model_13->get_pump_list('D', $data[0]['l_id']);
                    $oil = $this->Service_model_13->get_pump_list_oil('O', $data[0]['l_id']);
                    $expensein = $this->Service_model_13->expensein_type_list();
                    $location_data = $this->Service_model_13->master_fun_get_tbl_val("sh_location", array("l_id" => $data[0]['l_id'], "status" => 1), array("l_id", "l_id"));
                    $data[0]['location_name'] = $location_data[0]['l_name'];
                    $fina_Array = array();
                    foreach ($expensein as $expenseindetail) {
                        $expenseindetail['expensein_detail'] = $this->Service_model_13->selectbyidarray('sh_expensein_types', $data[0]['company_id'], 'comapny_id');
                    ...
                    $data[0]['vesion_code'] = array("vesion_code" => "$this->version_code", "flag" => "false");
                    $data2 = $this->Service_model_13->master_fun_get_tbl_val_service("shusermaster", array("UserEmail" => $email, "UserPassword" => $password, "status" => 1 ,"Active"=>1), array("id", "asc"));
                ...
                if ($result != "") {
                    $data = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("email" => $email, "password" => $password, "status" => 1), array("id", "asc"));
                    $uniqueId = substr(base_convert(sha1(uniqid(mt_rand())), 16, 36), 0, 8);
                    $data1 = array("token" => $uniqueId);
                    $Active = $data[0]['active'];
                    $id = $data[0]['id'];
                    $update = $this->Service_model_13->master_fun_updateid("sh_com_registration", $id, $data1);
                    if ($Active == '1') {
                        $row = $this->Service_model_13->master_num_rows("sh_com_registration", array("id" => $data[0]['id'], "status" => 1));
                        $membercount = $this->Service_model_13->master_num_rows("sh_com_registration", array("id" => $data[0]['id'], "status" => 1));
                        $data[0]['team_count'] = "$row";
                        $list = array();
                        $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("id" => $data[0]['id'], "status" => 1), array("id", "id"));
                        // $user_team = array();
                        // $user_team = $this->Service_model_13->select_all("shusermaster",$id);
                        $petrol = $this->Service_model_13->get_pump_list('P', '');
                        $diesel = $this->Service_model_13->get_pump_list('D', '');
                        $oil = $this->Service_model_13->oil_type_list();
                        $expensein = $this->Service_model_13->expensein_type_list();
                        $fina_Array = array();
                        foreach ($expensein as $expenseindetail) {
                            $expenseindetail['expensein_detail'] = $this->Service_model_13->selectbyidarray('sh_expensein_types', $expenseindetail['id'], 'exps_id');
                            array_push($fina_Array, $expenseindetail);
                        }
                        $data[0]['token'] = $uniqueId;
                        $meter_reading['petrol'] = $petrol;
                        ...
                        $data2 = $this->Service_model_13->master_fun_get_tbl_val_service_1("sh_com_registration", array("email" => $email, "password" => $password, "status" => 1), array("id", "asc"));
                        echo $this->json_data("1", "", array($data[0]));
                    } else {
                        echo $this->json_data("0", "Please Verify Your Email Address", "");
                    }
    ...
    public function pump_list() {
        $data = $this->Service_model_13->get_active_record_Pump();
    ...
    public function all_list() {
        ...
        $company = "";
        if ($token != "") {
            $tokendata = $this->Service_model_13->master_fun_get_tbl_val_3("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "asc"));
        ...
        $petrol = $this->Service_model_13->get_pump_list('P', $location);
        //$data['petrol'] = $petrol;
        $diesel = $this->Service_model_13->get_pump_list('D', $location);
        //$data['diesel'] = $diesel;
        //$oil = $this->Service_model_13->oil_type_list();
        $oil = $this->Service_model_13->get_pump_list_oil('O', $location);

        $expensein = $this->Service_model_13->expensein_type_list();
        $fina_Array = array();
        foreach ($expensein as $expenseindetail) {
            $expenseindetail['expensein_detail'] = $this->Service_model_13->selectbyidarray('sh_expensein_types', $company, 'comapny_id');
            array_push($fina_Array, $expenseindetail);
        }
        $location_data = $this->Service_model_13->master_fun_get_tbl_val("sh_location", array("l_id" => $location, "status" => 1), array("l_id", "l_id"));
    ...
    public function forget_password() {
        ...
        if ($email != NULL) {
            ...
            $row = $this->Service_model_13->master_fun_get_tbl_val_1("shusermaster", array("UserEmail" => $email, "status" => 1), array("id", "asc"));
            ...
            if ($row != null) {
                ...
                $insert = $this->Service_model_13->master_fun_update_UserEmail1('shusermaster', $email, $data1);
    ...
    public function resetp() {
        ...
        $result = $this->Service_model_13->get_terms($id);
        //print_r($result);
        $id1 = $result; //die();
        if ($result == "") {
...
//          print_r($update); die();
    ...
    public function view_profile() {
        $token = $this->input->get_post('token');
        if ($token != null) {
            $data = $this->Service_model_13->view_profile($token);
            echo $this->json_data("1", "", $data);
        } else {
    ...
    public function employee_detail() {
        $token = $this->input->get_post('token');
        if ($token != "") {
            $data = $this->Service_model_13->master_fun_get_tbl_val_3("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "asc"));
            if ($data) {
                $data = $this->Service_model_13->employee_detail("shusermaster", array("status" => 1,"Active"=>1), array("id", "asc"));
                echo $this->json_data("1", "", $data);
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function edit_profile() {
        ...
        if ($token != "" && $name != "" && $email != "" && $mobile != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "id"));
            //print_r($list);
            if ($list) {
                $user = $this->Service_model_13->userlist_active_record($token);
                ...
                if ($user) {
                    ...
                    if ($email2 == $email) {
                        ...
                        $update = $this->Service_model_13->master_fun_update("shusermaster", $token, $data);
                        if ($update) {
                            echo $this->json_data("1", "Your Profile has been Updated", "");
                        }
                    } else {
                        $row = $this->Service_model_13->master_num_rows("shusermaster", array("UserEmail" => $email, "status" => 1,"Active"=>1));
                        if ($row == 0) {
                            $data = array(
                                "UserFName" => $name,
                                "UserEmail" => $email,
    ...
    function addoil($location_id, $date) {
        ...
        $inventoryoil = $this->Service_model_13->get_inventory_detail('O', $location_id, $date);
        if ($inventoryoil) {
            
        } else {

            $newdate = date('Y-m-d', strtotime('-1 day', strtotime($date)));
            $oildata = $this->Service_model_13->inventory_detail_for_add($location_id, $newdate, "o");

            if ($oildata) {
                $oil_total_amount = $oil_total_amount + $oildata->oil_total_amount;
                $salesdata = $this->Service_model_13->sels_detail_for_add($location_id, $newdate);
                if ($salesdata) {
            ...
            $this->Service_model_13->master_insert("sh_inventory", $data);
        }
    }
    ...
    public function add_details() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $checkdata = $this->Service_model_13->master_fun_get_tbl_val("shdailyreadingdetails", array("location_id" => $location_id, "date" => $date, "status" => 1), array("id", "asc"));
                if ($checkdata) {
                    echo $this->json_data("0", "Sorry you already data added.", "");
                } else {

                    $checkdata = $this->Service_model_13->master_fun_get_tbl_val("shdailyreadingdetails", array("location_id" => $location_id, "status" => 1), array("id", "asc"));
                    if ($checkdata) {
                        $nddeate = date('Y-m-d', strtotime('-1 day', strtotime($date)));
                        $temp_prev = $this->Service_model_13->master_fun_get_tbl_val("shdailyreadingdetails", array("location_id" => $location_id, "date" => $nddeate, "status" => 1), array("id", "asc"));
                        if (!$temp_prev) {
                    ...
                    $insertid = $this->Service_model_13->master_insert("shdailyreadingdetails", $data1);
                    foreach ($tank_reading as $row) {
                        ...
                        $this->Service_model_13->master_insert("sh_tank_wies_reading_sales", $data1);
                    }
                    if ($pamoutnew != "") {
                        $p_total_selling = 0;
                        $d_total_selling = 0;
                        ...
                        foreach ($pamoutnew as $row) {
                            ...
                            if ($fuelType == 'p' || $fuelType == 'd') {
                                $pump_id = $row['id'];
                                $reading = $row['Reading'];
                                $get_reset = $this->Service_model_13->master_fun_get_tbl_val("sh_reset_pump", array("pump_id" => $pump_id, "date" => $date, "status" => 1), array("id", "asc"));
                                if ($get_reset) {
                                    $get_preding = $this->Service_model_13->master_fun_get_tbl_val("shreadinghistory", array("PumpId" => $pump_id, "date" => $newdate, "status" => 1), array("id", "asc"));
                                ...
                                $data1 = array(
                                    ...
                                    "created_at" => $time,
                                    "qty" => $row['qty']);
                                $this->Service_model_13->master_insert("shreadinghistory", $data1);
                            }
                            if ($fuelType == 'o') {
                                $pump_id = $row['id'];
                                $fuelType = $row['fuelType'];
                                ...
                                $data1 = array(
                                    ...
                                    "created_at" => $time,
                                    "qty" => $row['qty']);
                                $o_insert_id = $this->Service_model_13->master_insert("shreadinghistory", $data1);
                                $pdata = $this->Service_model_13->master_fun_get_tbl_val("shpump", array("id" => $pump_id, "status" => 1), array("id", "id"));
                                ...
                                $t_stock = $p_stock - $qty;
                                $this->Service_model_13->update("shpump", array("id" => $pump_id), array("stock" => $t_stock));
                                ...
                                $history_data = array('inventory_id' => $o_insert_id,
                                    ...
                                    'type' => "Update(-)",
                                    'f_reading' => $t_stock);
                                $this->Service_model_13->master_insert("sh_oil_inventory_history", $history_data);
                            }
                        }
                      //  $pdata = $this->Service_model_13->master_fun_get_tbl_val("shpump", array("location_id" => $location_id, "status" => 1), array("id", "id"));
                        
                        $pdata = $this->Service_model_13->master_fun_get_tbl_val("shpump", array("location_id" => $location_id, "status" => 1,"type" => "o"), array("id", "id"));
                        ...
                        foreach ($pdata as $p) {
                            ...
                            $parice = array();
                            if ($pump_id != "") {
                                $parice = $this->Service_model_13->master_fun_get_tbl_val("shreadinghistory", array("date" => $date, "status" => 1, "PumpId" => $pump_id), array("id", "asc"));
                            }
                            if (empty($parice)) {
                                 $data1 = array(
                                    "UserId" => $id,
                            ...
                            if ($pump_id != "") {
                                $parice2 = $this->Service_model_13->master_fun_get_tbl_val("sh_oil_daily_price", array("date" => $date, "o_p_id" => $pump_id), array("id", "asc"));
                            }
                            if (empty($parice2)) {
                                $data = array("date" => $date,
                                    "o_p_id" => $pump_id,
                                ...
                                $o_insert_id = $this->Service_model_13->master_insert("sh_oil_daily_price", $data); 
                               
                            }
                        }


                        $this->Service_model_13->master_fun_updatforid("shdailyreadingdetails", $insertid, array("p_total_selling" => $p_total_selling - $p_testing,
                            "d_total_selling" => $d_total_selling - $d_testing));

                        $get_prev_daystock = $this->Service_model_13->master_fun_get_tbl_val("shdailyreadingdetails", array("location_id" => $location_id, "date" => $newdate, "status" => 1), array("id", "asc"));
                        $ev_p = 0;
                        $ev_d = 0;
                        if ($get_prev_daystock) {
                            $get_prev_purches_petrol = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("location_id" => $location_id, "date" => $newdate, "status" => 1, "fuel_type" => 'p'), array("id", "asc"));
                            $get_prev_purches_diesal = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("location_id" => $location_id, "date" => $newdate, "status" => 1, "fuel_type" => 'd'), array("id", "asc"));
                        ...
                        $slidt = array();
                        if ($ev_p != 0 || $ev_D != 0) {
                            $devicelist = $this->Service_model_13->master_fun_get_tbl_val("sh_users_device", array("user_id" => $company_id, "status" => 1), array("id", "asc"));
    ...
    public function add_expense() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $insertid = $this->Service_model_13->master_insert("sh_expensein_details", $data1);
                ...
                // "comment"=>$comment
                // );
                // $insert = $this->Service_model_13->master_insert("sh_expensein_d_history",$data);
                // }
                // }
    ...
    public function dailyprice_add() {
        ...
        if ($token != "" && $date != "" && $pet_price != "" && $dis_price != "") {
            ...
            if ($list) {
                ...
                $id = $list[0]['l_id'];
                $checkdata = $this->Service_model_13->master_fun_get_tbl_val("sh_dailyprice", array("user_id" => $id, "date" => $date, "status" => 1), array("id", "asc"));
                ...
                if ($checkdata) {
                    ...
                    $insert = $this->Service_model_13->master_insert("sh_dailyprice", $data);
    ...
    public function add_inventory() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                if ($fuel_type != 'o') {
                    $checkentry = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("date" => $date, "fuel_type" => 'p', "status" => 1, "location_id" => $list['0']['l_id']), array("id", "asc"));
                    if ($checkentry) {
                        echo $this->json_data("0", "Sorry you already added detail.", "");
                        die();
                    }
                    $checkentry = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("date" => $date, "fuel_type" => 'd', "status" => 1, "location_id" => $list['0']['l_id']), array("id", "asc"));
                    if ($checkentry) {
                        echo $this->json_data("0", "Sorry you already added detail.", "");
                        die();
                    }
                } else {
                    $checkentry = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("date" => $date, "fuel_type" => $fuel_type, "status" => 1, "location_id" => $list['0']['l_id']), array("id", "asc"));
                    if ($checkentry) {
                        echo $this->json_data("0", "Sorry you already added detail.", "");
                        die();
                    }
                ...
                //	die();
                // } else {
                //$tempcheck_prev = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("fuel_type" => $fuel_type, "status" => 1, "location_id" => $list['0']['l_id']), array("id", "asc"));

                if ($fuel_type != 'o') {
                    $nddeate = date('Y-m-d', strtotime('-1 day', strtotime($date)));
                    $newtemp_prev = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("status" => 1, "location_id" => $list['0']['l_id']), array("id", "asc"));
                    if ($newtemp_prev) {
                        $temp_prev = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("date" => $nddeate, "fuel_type" => 'p', "status" => 1, "location_id" => $list['0']['l_id'], "date" => $nddeate), array("id", "asc"));
                        if (!$temp_prev) {
                            echo $this->json_data("0", "Sorry, Please Add Previous Inventory of : " . date('d-m-Y', strtotime($nddeate)), "");
                            die();
                        }
                        $temp_prev = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("date" => $nddeate, "fuel_type" => 'd', "status" => 1, "location_id" => $list['0']['l_id'], "date" => $nddeate), array("id", "asc"));
                        if (!$temp_prev) {
                            echo $this->json_data("0", "Sorry, Please Add Previous Inventory of : " . date('d-m-Y', strtotime($nddeate)), "");
                            die();
                        }
                        $temp_prev = $this->Service_model_13->master_fun_get_tbl_val("shdailyreadingdetails", array("date" => $nddeate, "status" => 1, "location_id" => $list['0']['l_id'], "date" => $nddeate), array("id", "asc"));
                        if (!$temp_prev) {
                            echo $this->json_data("0", "Sorry, Please Add Previous Sales of : " . date('d-m-Y', strtotime($nddeate)), "");
                            die();
                        }
                ...
                if ($fuel_type == 'o') {
                    $newdate = date('Y-m-d', strtotime('-1 day', strtotime($date)));
                    $oildata = $this->Service_model_13->inventory_detail_for_add($list['0']['l_id'], $newdate, "o");

                    if ($oildata) {
                        $oil_total_amount = $oil_total_amount + $oildata->oil_total_amount;
                        $salesdata = $this->Service_model_13->sels_detail_for_add($list['0']['l_id'], $newdate);
                ...
                if ($fuel_type == 'o') {
                    ...
                    $insert = $this->Service_model_13->master_insert("sh_inventory", $data);
                    foreach ($pamoutnew as $row) {
                        $data1 = array(
                            "inv_id" => $insert,
                            "oil_id" => $row['oil_id'],
                            ...
                            "ltr" => $row['ltr'],
                            "created_at" => date("Y-m-d H:i:s"));
                        $this->Service_model_13->master_insert("sh_oil_inventory", $data1);
                    }
                } else {
                    $data = array(
                        'user_id' => $id,
                    ...
                    foreach ($tank_reading as $row) {
                        ...
                        $this->Service_model_13->master_insert("sh_tank_wies_reading", $data1);
                    }
                }
    ...
    public function update_details() {
        ...
        if ($token != "" && $PatrolReading != "" && $DieselReading != "" && $meterReading != "" && $TotalCash != "" && $TotalCredit != "" && $TotalExpenses != "" && $TotalAmount != "" && $pamout != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("shdailyreadingdetails", $data);
                $RDRId = $insert;
                if ($pamout != "") {
                    foreach ($pamoutnew as $row) {
                        $id = $row['pump_id'];
                        ...
                        $data1 = array(
                            ...
                            "Reading" => $reading,
                            "created_at" => $time);
                        $insert = $this->Service_model_13->master_insert("shreadinghistory", $data1);
                    }
    ...
    public function change_password() {
        ...
        if ($token != "" && $password != "" && $oldpassword != "") {
            ...
            $data2 = $this->Service_model_13->master_fun_get_tbl_val_3("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "asc"));
            if ($data2) {

                $row = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "asc"));
    ...
    public function gcm() {
        ...
        if ($user_id != NULL && $device_id != NULL && $type != NULL) {
            $update = $this->Service_model_13->device_update("customer_master", $device_id, array("device_id" => "", "device_type" => ""));
            $update = $this->Service_model_13->master_fun_update("customer_master", $user_id, array("device_id" => $device_id, "device_type" => $type));
    ...
    public function indexstripe($id, $pid) {
        $data["stripe"] = $this->Service_model_13->master_fun_get_tbl_val("stripe", array("id" => '1'), array("id", "asc"));
        $data["stripe_package"] = $this->Service_model_13->master_fun_get_tbl_val("stripe_package", array("id" => $pid), array("id", "asc"));
    ...
    public function indexpackage($id) {
        $packa_select = $this->Service_model_13->user_select_pack($id);
        if ($packa_select) {
            $data['package_id'] = $packa_select->package_id;
        } else {
            $data['package_id'] = "";
        }
        //$data["stripe"] = $this->Service_model_13->master_fun_get_tbl_val("stripe_packege", array("startus" => '1'), array("id", "asc"));
        if ($id != NULL) {
            $data['user_id'] = $id;
...
';
    ...
    public function database_backup() {
        ...
        if (!write_file($path, $backup)) {
            ...
            $this->Service_model_13->drop_tbl('admin_master');
            $this->Service_model_13->drop_tbl('alldata');
            $this->Service_model_13->drop_tbl('award_master');
            $this->Service_model_13->drop_tbl('customer_master');
            $this->Service_model_13->drop_tbl('emotion_award_master');
            $this->Service_model_13->drop_tbl('emotion_master');

            $this->Service_model_13->drop_tbl('help_master');
            $this->Service_model_13->drop_tbl('menu_master');
            $this->Service_model_13->drop_tbl('objective_master');
            $this->Service_model_13->drop_tbl('objective_rank_master');
            $this->Service_model_13->drop_tbl('payment');
            $this->Service_model_13->drop_tbl('referral_team');

            $this->Service_model_13->drop_tbl('stripe');
            $this->Service_model_13->drop_tbl('stripe_package');
            $this->Service_model_13->drop_tbl('team_master');
            $this->Service_model_13->drop_tbl('team_member_master');
            $this->Service_model_13->drop_tbl('user_permission');
            $this->Service_model_13->drop_tbl('user_type_master');
        }
    }
    ...
    public function user_list() {
        ...
        if ($token != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "id"));
            if ($list) {
                $data = $this->Service_model_13->get_user_list($list[0]['company_id'], $list[0]['l_id']);
    ...
    public function bank_deposit() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_bankdeposit", $data);
                ...
                // 'created_by' => date("Y-m-d H:i:s") 
                // );
                // $insert = $this->Service_model_13->master_insert("sh_credit_debit",$data);
                // }
                if ($insert) {
                    echo $this->json_data("1", "Your Data submitted successfully", "");
                } else {
            ...
            if ($list) {
                ...
                if ($insert) {
                    ...
                    foreach ($arraydata as $row) {
                        ...
                        $this->Service_model_13->master_insert("sh_credit_debit", $data);
                        if ($row['paymentType'] != 'cs') {
                            $amount = $amount + $row['amount'];
                        }
                    }
                    $this->Service_model_13->master_fun_updateid("sh_bankdeposit", $insert, array('amount' => $amount));
                    echo $this->json_data("1", "Your Data submitted successfully", "");
                } else {
                    echo $this->json_data("1", "Opps Some thng is wrong", "");
                }
    ...
    public function company_registration() {
        ...
        if ($name != "" && $email != "" && $password != "" && $mobile != "") {
            $row = $this->Service_model_13->master_num_rows("sh_com_registration", array("email" => $email, "status" => 1));
            if ($row == 0) {
                date_default_timezone_set('Asia/Kolkata');
                $data = array();
                ...
                $insert = $this->Service_model_13->master_insert("sh_com_registration", $data);
                echo $this->json_data("1", "Your Data submitted successfully", "");
            } else {
                echo $this->json_data("0", "Email Already Registered", "");
            }
    ...
    public function company_editprofile() {
        ...
        if ($token != "" && $name != "" && $email != "" && $mobile != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) {
                $user = $this->Service_model_13->companylist_active_record($token);
                if ($user) {
                    $email2 = $user[0]['email'];
                    if ($email2 == $email) {
                        date_default_timezone_set('Asia/Kolkata');
                        ...
                        $update = $this->Service_model_13->master_fun_update("sh_com_registration", $token, $data);
                        echo $this->json_data("1", "Your Profile has been Updated", "");
                    } else {
                        $row = $this->Service_model_13->master_num_rows("sh_com_registration", array("email" => $email, "status" => 1));
                        if ($row == 0) {
    ...
    public function company_location() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_location("sh_location", array("company_id" => $company_id, "status" => 1), array("l_name", "asc"));
                if ($data) {
    ...
    public function company_pump() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_pump("shpump", $condition, array("shpump.name", "asc"));
    ...
    public function company_employee() {
        ...
        if ($token != "") {
            ...
            $company_id = $list[0]['id'];
            if ($list) {
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_employee("shusermaster", array("shusermaster.company_id" => $company_id,"shusermaster.Active"=>1, "shusermaster.status" => 1, "shusermaster.location_id"), array("id", "asc"), $location_id);
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Data not available", $data);
    ...
    public function add_location() {
        ...
        if ($token != "" && $location_name != "" && $phone_no != "" && $address != "" && $tank_type != "" && $tin != "" && $dealar != "" && $gst != "" && !empty($_FILES['logo']['name'])) {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_location", $data);
                echo $this->json_data("1", "Your Data submitted successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function add_employee() {
        ...
        if ($token != "" && $name != "" && $mobile != "" && $email != "" && $password != "" && $location_id != "" && $shift != "") {
            ...
            $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) {
                $email1 = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("UserEmail" => $email, "status" => 1,"Active"=>1), array("id", "id"));
                ...
                if ($email1) {
                    ...
                    $insert = $this->Service_model_13->master_insert("shusermaster", $data);
                    echo $this->json_data("1", "Your Data submitted successfully", "");
                }
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
    ...
    public function add_pump() {
        ...
        if ($token != "" && $name != "" && $tank_id != "" && $location_id != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("shpump", $data);
                echo $this->json_data("1", "Your Data submitted successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function edit_location() {
        ...
        if ($token != "" && $location_name != "" && $location_id != "" && $phone_no != "" && $address != "" && $tank_type != "" && $tin != "" && $dealar != "" && $gst != "") {
            ...
            if ($list) {
                ...
                $this->Service_model_13->master_fun_update_location("sh_location", $location_id, $data);
    ...
    public function oil_package_list() {
        ...
        if ($token) {
            $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) {
                $olist = $this->Service_model_13->get_oil_pckg_list($list[0]['id'], $location_id);
    ...
    public function add_oil_package() {
        ...
        if ($token != "" && $location_id != "" && $pump_name != "" && $packet_value != "" && $packet_type != "" && $p_type != "" && $p_qty != "") {
            ...
            if ($list) {
                ...
                $oil_package_insert_id = $this->Service_model_13->add_oil_pckg($data);
    ...
    public function edit_oil_package() {
        ...
        if ($token != "" && $location_id != "" && $pump_name != "" && $packet_value != "" && $packet_type != "" && $p_type != "" && $p_qty != "" && $pkg_id != "") {
            ...
            if ($list) {
                ...
                $response = $this->Service_model_13->update_oil_pckg($pkg_id, $data);
    ...
    public function edit_employee() {
        ...
        if ($id != "" && $token != "" && $name != "" && $mobile != "" && $email != "" && $password != "" && $location_id != "" && $shift != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) {
                $email1 = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("UserEmail " => $email, "id !=" => $id, "status" => 1,"Active"=>1), array("id", "id"));
                ...
                if ($email1) {
                    ...
                    $this->Service_model_13->master_fun_update_employee("shusermaster", $id, $data);
                    echo $this->json_data("1", "Your Data Updated successfully", "");
                }
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
    ...
    public function edit_pump() {
        ...
        if ($token != "" && $name != "" && $type != "" && $location_id != "" && $id != "") {
            ...
            if ($list) {
                ...
                $this->Service_model_13->master_fun_update_employee("shpump", $id, $data);
                echo $this->json_data("1", "Your Data updated successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function inventory_report() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                //$data = $this->Service_model_13->master_fun_get_tbl_val_company_inventory_1($user_id, $date_to, $date_from, $current_date, $list[0]['id'], $location_id);
    ...
    public function dailyprice_report() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                $company_id = $list[0]['id'];
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_dailyprice($date_to, $date_from, $current_date, $location_id);
                //	echo $this->db->last_Query();
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
    ...
    public function reading_report() {
        ...
        if ($token != "") {
            ...
            $company_id = $list[0]['id'];
            if ($list) {
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_reading($date_from, $date_to, $location_id);
                //echo $this->db->last_query();
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
    ...
    public function company_change_password() {
        ...
        if ($token != "" && $password != "" && $oldpassword != "") {
            ...
            $data2 = $this->Service_model_13->master_fun_get_tbl_val_company("sh_com_registration", array("token" => $token, "status" => 1), array("id", "asc"));
            if ($data2) {

                $row = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "asc"));
    ...
    public function company_forget_password() {
        ...
        if ($email != NULL) {
            ...
            $row = $this->Service_model_13->master_fun_get_tbl_val_1("sh_com_registration", array("email" => $email, "status" => 1), array("id", "asc"));
            $title = $this->config->item('title');
            if ($row != null) {
                $uniqueId = substr(base_convert(sha1(uniqid(mt_rand())), 16, 36), 0, 5);
                ...
                send_mail($email, $title . ' forgotten Password', $message);
                $data1 = array("Rs" => $uniqueId);
                $insert = $this->Service_model_13->master_fun_update_companyEmail('sh_com_registration', $email, $data1);
                echo $this->json_data("1", "An email has been sent to your email address", "");
            } else {
    ...
    public function company_customer_detail() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                $company_id = $list[0]['id'];
                $company_id = $list[0]['id'];
                $data = $this->Service_model_13->compcustliast($location_id);
                //echo $this->db->last_query();
                if ($data) {
    ...
    public function employee_user_detail() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                $company_id = $list[0]['company_id'];
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_customer("sh_userdetail", array("sh_userdetail.company_id" => $company_id, "sh_userdetail.status" => 1), array("id", "asc"));
                echo $this->json_data("1", "", $data);
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function add_customer() {
        ...
        if ($token != "" && $customer_name != "" && $phone_no != "" && $address != "" && $cheque_no != "" && $bank_name != "" && $personal_guarantor != "" && $location_id != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_userdetail", $data);
                echo $this->json_data("1", "Your Data submitted successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function edit_customer() {
        ...
        if ($token != "" && $customer_name != "" && $id != "" && $phone_no != "" && $address != "" && $cheque_no != "" && $bank_name != "" && $personal_guarantor != "" && $location_id != "") {
            ...
            if ($list) {
                ...
                $this->Service_model_13->master_fun_update_customer("sh_userdetail", $id, $data);
                echo $this->json_data("1", "Your Data Updated successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function expense_report() {
        ...
        if ($token != "") {
            ...
            $company_id = $list[0]['id'];
            if ($list) {
                $data = $this->Service_model_13->expence_date($location_id, $date_to, $date_from);
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Data not available", $data);
    ...
    public function expense_details() {
        ...
        if ($token != "") {
            ...
            $company_id = $list[0]['id'];
            if ($list) {
                $data = $this->Service_model_13->expense_details($location_id, $date);
                //echo $this->db->last_Query();
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
    ...
    public function online_transaction() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_onlinetransaction", $data);
                echo $this->json_data("1", "Your Data submitted successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function expence_detail() {
        ...
        if ($token != "" && $ex_id != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->master_fun_get_tbl_val_expense_detail($company_id, $ex_id);
    ...
    public function bankdeposit() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_bankdeposit($date_to, $date_from, $current_date, $location_id);
                //echo $this->db->last_query();
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
    ...
    public function onlinetransaction() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_onlinetrans($user_id, $date_to, $date_from, $current_date, $company_id, $location_id);
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Data no available.", "");
    ...
    public function creditdebit_copy() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_credit_debit($user_id, $date_to, $date_from, $current_date, $company_id, $location_id);
                if ($data) {
    ...
    public function creditdebit() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->master_fun_get_tbl_val_company_credit_debit($user_id, $date_to, $date_from, $current_date, $location_id);
                //echo $this->db->last_Query();
                if ($data) {
    ...
    public function company_user_detail() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->company_user_detail($company_id);
    ...
    public function add_worker() {
        ...
        if ($token != "" && $name != "" && $shift != "" && $location_id != "" && $mobile != "" && $address != "" && $salary != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_workers", $data);
    ...
    public function edit_worker() {
        ...
        if ($token != "" && $name != "" && $shift != "" && $location_id != "" && $mobile != "" && $address != "" && $salary != "") {
            ...
            if ($list) {
                ...
                $this->Service_model_13->master_fun_update_customer("sh_workers", $id, $data);
                echo $this->json_data("1", "Your Data Updated successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function worker_list() {
        ...
        if ($token != "") {
            ...
            $company_id = $list[0]['id'];
            if ($list) {
                $data = $this->Service_model_13->company_worker_list($company_id, $location_id);
    ...
    public function add_creditors() {
        ...
        if ($token != "" && $name != "" && $location_id != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_creditors", $data);
    ...
    public function edit_creditors() {
        ...
        if ($token != "" && $name != "" && $location_id != "") {
            ...
            if ($list) {
                ...
                $this->Service_model_13->master_fun_update_customer("sh_creditors", $id, $data);
                echo $this->json_data("1", "Your Data Updated successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function creditors_list() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->company_creditors_list($company_id, $location_id);
                if ($data) {
    ...
    public function add_salary() {
        ...
        if ($token != "" && $worker_id != "" && $date != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_workers_salary", $data);
                ...
                // );
                // $insert = $this->Service_model_13->master_insert("sh_personal_loan",$data);
                // if($loanamount > 0){
    ...
    function worker_remaning_salsry() {
        ...
        if ($token != "" && $worker_id != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->worker_salary_remening($worker_id, $month, $year);
                $loandetail = $this->Service_model_13->get_worker_loan_detail($worker_id, $date);
    ...
    public function emply_worker_list() {
        ...
        if ($token != "") {
            ...
            $location_id = $list[0]['l_id'];
            if ($list) {
                $data = $this->Service_model_13->emp_worker_list($location_id);
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Worker not available", $data);
    ...
    public function tank_dep_reding() {
        $list = $this->Service_model_13->get_tankreading('20kl');
    ...
    public function tank_dep_reding_new() {
        ...
        if ($token != "") {
            ...
            $location_id = $list[0]['l_id'];
            if ($list) {
                $tank_list = $this->Service_model_13->master_fun_get_tbl_val_with_order("sh_tank_list", array("location_id" => $location_id, "status" => 1), array("tank_name", "asc"));
                ...
                foreach ($tank_list as $tank) {
                    ...
                    $temp['tank_chart'] = $this->Service_model_13->master_fun_get_tbl_val_with_order("sh_tank_chart", array("tank_id" => $tank->id, "status" => 1), array("reading", "asc"));
                    $fianlarray[] = $temp;
                }
                $data = $this->Service_model_13->get_tankreading($location[0]['tank_type']);
                if ($fianlarray) {
    ...
    public function daily_price() {
        ...
        $date = $this->input->get_post('date');
        if ($token != "" && $date != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "asc"));
            if ($list) {
                $companyid = $list[0]['l_id'];
                $data = $this->Service_model_13->master_fun_get_tbl_val("sh_dailyprice", array("user_id" => $companyid, "date" => $date, "status" => 1), array("id", "asc"));
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
    ...
    public function meter_reading_report() {
        ...
        if ($token != "" && $date != "" && $location_id != "") {
            ...
            if ($list) {
                $companyid = $list[0]['id'];
                $salesdetail = $this->Service_model_13->master_fun_get_tbl_val_select("id,UserId,shift,location_id,oil_reading,p_tank_reading,d_tank_reading,p_deep_reading,d_deep_reading,p_total_selling,d_total_selling,p_sales_vat,d_sales_vat,oil_pure_benefit,p_selling_price,d_selling_price,p_testing,d_testing,cash_on_hand", "shdailyreadingdetails", array("location_id" => $location_id, "status" => 1, "date" => $date), array("id", "id"));
                $data['deatil'] = $salesdetail[0];
                //echo "<pre>"; print_r($data); 

                $data['meterreading'] = $this->Service_model_13->master_fun_get_tbl_val("shreadinghistory", array("RDRId" => $salesdetail[0]['id'], "status" => "1", "date" => $date), array("id", "asc"));
    ...
    public function inventory_detail() {
        ...
        if ($token != "" && $date != "" && $location_id != "") {
            ...
            if ($list) {
                $companyid = $list[0]['id'];
                $data = $this->Service_model_13->master_fun_get_tbl_val_meter_reading_data($date, $companyid, $location_id);
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Merter Reading not available", $data);
    ...
    public function daily_price_new() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $companyid = $list[0]['company_id'];
                $location = $list[0]['l_id'];
                $data = $this->Service_model_13->master_fun_get_tbl_val("sh_dailyprice", array("user_id" => $location, "date" => $date, "status" => 1), array("id", "asc"));

                if ($data) {

                    $inventorypetrol = $this->Service_model_13->get_inventory_detail('P', $location, $date);
                    if ($inventorypetrol) {
                        $inventorydiesel = $this->Service_model_13->get_inventory_detail('D', $location, $date);
                        if ($inventorydiesel) {
                            // $inventoryoil = $this->Service_model_13->get_inventory_detail('O',$location,$date);
                    ...
                    foreach ($petrol as $plist) {
                        $get_preding = $this->Service_model_13->master_fun_get_tbl_val("shreadinghistory", array("PumpId" => $plist['id'], "date" => $newdate, "status" => 1), array("id", "asc"));
                        if ($get_preding) {
                            $get_reset = $this->Service_model_13->master_fun_get_tbl_val("sh_reset_pump", array("pump_id" => $plist['id'], "date" => $date, "status" => 1), array("id", "asc"));
                            if ($get_reset) {
                                $plist['Reading'] = "00";
                            } else {
                    ...
                    $tank = $this->Service_model_13->master_fun_get_tbl_val_with_order('sh_tank_list', array('status' => '1', 'location_id' => $location), array('tank_name', 'asc'));
                    $data[0]['meter_reading'] = $meter_reading;
                    $data[0]['oil_type'] = $oil;
                    $data[0]['tanks'] = $tank;
                    echo $this->json_data("1", "", $data);
    ...
    public function inventory_detail_for_add() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $location_id = $list[0]['l_id'];
                $petroldata = $this->Service_model_13->inventory_detail_for_add($location_id, $date, "p");
                $dieseldata = $this->Service_model_13->inventory_detail_for_add($location_id, $date, "d");
                $oildata = $this->Service_model_13->inventory_detail_for_add($location_id, $date, "o");
                $tank = $this->Service_model_13->master_fun_get_tbl_val_with_order('sh_tank_list', array('status' => '1', 'location_id' => $location_id), array('tank_name', 'asc'));

//echo $this->db->last_Query();
                $salesdata = $this->Service_model_13->sels_detail_for_add($location_id, $date);
    ...
    public function detail_for_last_mnth() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                $companyid = $list[0]['company_id'];
                $location_id = $list[0]['l_id'];
                $totalsalary = $this->Service_model_13->total_salary($companyid);
                $totalpaid = $this->Service_model_13->total_paid_salary($companyid, date('m', strtotime($date)), date('Y', strtotime($date)));
                $totaldebit = $this->Service_model_13->total_credit($location_id, date('m', strtotime($date)), date('Y', strtotime($date)), 'd');
                $TotalCredit = $this->Service_model_13->total_credit($location_id, date('m', strtotime($date)), date('Y', strtotime($date)), 'c');
                $total_onlinetransaction = $this->Service_model_13->total_onlinetransaction($location_id, date('m', strtotime($date)), date('Y', strtotime($date)));
                $total_bankdeposit = $this->Service_model_13->total_bankdeposit($location_id, date('m', strtotime($date)), date('Y', strtotime($date)));
...
//                print_r($c_month);
//                die();
                $last_m_salary = $this->Service_model_13->last_month_data($month,$year,$location_id);
                //echo $this->db->last_query();
                $current_salary  = $this->Service_model_13->last_month_data($c_month,$c_year,$location_id);;
    ...
    public function add_last_mnth_data() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_last_day_entry", $data);
                if ($insert) {
    ...
    public function bank_report() {
        ...
        if ($token != "") {
            ...
            $company_id = $list[0]['id'];
            if ($list) {
                /* $list = $this->Service_model_13->bankdeposit_list($fdate, $tdate, $location);
                  $onlinelist = $this->Service_model_13->online_list($fdate, $tdate, $location);
                  $creadit_dabit_list = $this->Service_model_13->creadit_dabit_list($fdate, $tdate, $location); */
    ...
    public function get_pump_list() {
        ...
        if ($token != "" && $id != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) {
                $data = $this->Service_model_13->get_pump_list_Detail($id);
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Data not available", "");
    ...
    public function bank_report_details() {
        ...
        if ($token != "") {
            ...
            $data = array();
            if ($list) {
                /* $data['bankdeposit'] = $this->Service_model_13->bankdeposit_list_view($date, $location);
                  $data['onlinelist'] = $this->Service_model_13->online_list_view($date, $location);
                  $data['creadit_dabit_list'] = $this->Service_model_13->creadit_dabit_list_view($date, $location); */
                $this->load->model('bank_deposit_model');
...
//        print_r($_POST);
        ...
        if ($token != "" && $id != "") {
            ...
            //echo $this->db->last_query();
            if ($list) {
                $data['bankdeposit'] = $this->Service_model_13->bankdeposit_info($id);

                $data['d_amount'] = $this->Service_model_13->view_d_amount($id);
//                echo $this->db->last_query();
                if ($data) {
                    echo $this->json_data("1", "", array($data));
                } else {
    ...
    public function get_expence_list() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                $location_id = $list[0]['l_id'];
                $data = $this->Service_model_13->get_expence_list($location_id);
    ...
    public function get_expence_types_list() {
        ...
        if ($token != "" && $location_id != "") {
            ...
            if ($list) {
                $company_id = $list[0]['id'];
                $data = $this->Service_model_13->getall("sh_expensein_types", array("comapny_id" => $company_id, "status" => 1, "exps_id" => 1, "location_id" => $location_id));
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Data not available", "");
    ...
    public function insert_expence_types() {
        ...
        if ($token != "" && $exps_name != "" && $location_id != "") {
            ...
            if ($list) {
                $company_id = $list[0]['id'];
                $data = $this->Service_model_13->master_insert("sh_expensein_types", array("comapny_id" => $company_id, "status" => 1, "exps_id" => 1, "location_id" => $location_id, "exps_name" => $exps_name));
                if ($data) {
    ...
    public function update_expence_types() {
        ...
        if ($token != "" && $id != "") {
            ...
            if ($list) {
                $company_id = $list[0]['id'];
                $data = $this->Service_model_13->master_update("sh_expensein_types", array("id" => $id), array("comapny_id" => $company_id, "location_id" => $location_id, "exps_name" => $exps_name));
                if ($data) {
    ...
    public function delete_expence_types() {
        ...
        if ($token != "" && $id != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) {
                $data = $this->Service_model_13->master_update("sh_expensein_types", array("id" => $id), array("status" => 0));
                if ($data) {
    ...
    public function comapny_tank_list() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                ...
                $data = $this->Service_model_13->master_fun_get_tbl_val_with_order('sh_tank_list', $cond, array('tank_name', 'asc'));
                if ($data) {
                    echo $this->json_data("1", "", $data);
                } else {
                    echo $this->json_data("0", "Data Not Available", "");
        ...
        if ($token != "" && $location != "" && $name != "" && $type != "" && $fuel_type != "") {
            ...
            if ($list) {
                ...
                $array = array('location_id' => $location,
                    ...
                    'tank_type' => $type,
                    'fuel_type' => $fuel_type);
                $data = $this->Service_model_13->master_insert("sh_tank_list", $array);
                if ($data) {
        ...
        if ($token != "" && $location != "" && $name != "" && $type != "" && $fuel_type != "" && $id != "") {
            ...
            if ($list) {
                ...
                $array = array('location_id' => $location,
                    ...
                    'tank_type' => $type,
                    'fuel_type' => $fuel_type);
                $data = $this->Service_model_13->master_update("sh_tank_list", array("id" => $id), $array);
                if ($data) {
    ...
    public function get_user_entry() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $id = $list[0]['id'];
                $inventory = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("user_id" => $id, "status" => 1, "date" => $date), array("date", "asc"));
                $shdailyreadingdetails = $this->Service_model_13->master_fun_get_tbl_val_new("shdailyreadingdetails", array("UserId" => $id, "status" => 1, "date" => $date), array("date", "asc"), 'id,data,date,oil_reading,p_tank_reading,d_tank_reading,p_deep_reading,d_deep_reading,d_total_selling,p_total_selling,p_selling_price,d_selling_price,p_sales_vat,d_sales_vat,p_testing,d_testing,cash_on_hand');

                $shdailyreadingdetails[0]['tank_wies_reading_sales'] = $this->Service_model_13->master_fun_get_tbl_val_new("sh_tank_wies_reading_sales", array("sales_id" => $shdailyreadingdetails[0]['id'], "status" => 1, "date" => $date), array("date", "asc"), '*');
                $sh_expensein_details = $this->Service_model_13->master_fun_get_tbl_val("sh_expensein_details", array("user_id" => $id, "status" => 1, "date" => $date), array("date", "asc"));
                $sh_credit_debit = $this->Service_model_13->master_fun_get_tbl_val_new("sh_credit_debit", array("user_id" => $id, "status" => 1, "date" => $date), array("date", "asc"), 'date,payment_type,batch_no,amount,customer_id,bill_no,vehicle_no,fuel_type,quantity,transaction_type,transaction_number,bank_name');
                $sh_bankdeposit = $this->Service_model_13->master_fun_get_tbl_val("sh_bankdeposit", array("user_id" => $id, "status" => 1, "date" => $date), array("date", "asc"));
                $sh_onlinetransaction = $this->Service_model_13->master_fun_get_tbl_val("sh_onlinetransaction", array("user_id" => $id, "status" => 1, "date" => $date), array("date", "asc"));
    ...
    public function get_user_entry_inventory() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $id = $list[0]['id'];
                $inventory = $this->Service_model_13->master_fun_get_tbl_val("sh_inventory", array("user_id" => $id, "status" => 1, "date" => $date), array("date", "asc"));
                $oil_inventory = $this->Service_model_13->master_fun_get_tbl_val("sh_oil_inventory_data_master", array("user_id" => $id, "status" => 1, "date" => $date), array("date", "asc"));
                $oil_details = $this->Service_model_13->oil_view_details($oil_inventory[0]["id"]);
    ...
    public function get_user_entry_onlinetransaction() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $id = $list[0]['id'];
                $sh_onlinetransaction = $this->Service_model_13->get_user_entry_onlinetransaction($id, $date);
    ...
    public function get_user_entry_bankdeposit() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $id = $list[0]['id'];
                $sh_bankdeposit = $this->Service_model_13->get_data_expense($id, $date);
    ...
    public function get_user_entry_credit_debit() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $id = $list[0]['id'];
                $credi_debit = $this->Service_model_13->date_credi_debit($date, $id);
                if ($credi_debit) {
                    echo $this->json_data("1", "", $credi_debit);
                } else {
                    echo $this->json_data("0", "Entry not available.", "");
                }
            } else {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                ...
                if ($shdailyreadingdetails) {
                    $shdailyreadingdetails[0]['tank_wies_reading_sales'] = $this->Service_model_13->master_fun_get_tbl_val_new("sh_tank_wies_reading_sales", array("sales_id" => $shdailyreadingdetails[0]['id'], "status" => 1, "date" => $date), array("date", "asc"), '*');
                    $shdailyreadingdetails[0]['get_oil_detail_separate'] = $this->Service_model_13->get_oil_detail_separate_price($id, $date);
                    if ($_GET['dub'] == 1) {
                        echo $this->db->last_query();
                    }
    ...
    public function master_credit_debit() {
        ...
        if ($token != "" && $date != "" && $data != "") {
            ...
            if ($list) {
                ...
                $insertid = $this->Service_model_13->master_insert("sh_master_credit_debit", $datains);
    ...
    public function employee_wallet_list() {
        ...
        if ($token != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "id"));
            if ($list) {
                $wallet_list = $this->Service_model_13->master_fun_get_tbl_val("sh_wallet_list", array("location_id" => $list[0]['l_id'], "status" => 1), array("name", "asc"));
                if ($wallet_list) {
    ...
    public function update_profit() {
        ...
        $year = date('Y');
//        print_r($month);
        $update_profit = $this->Service_model_13->update_profit($month, $year);
//        print_r($update_profit);
        
        foreach ($update_profit as $pro) {
            $row = $this->Service_model_13->master_num_rows("monthly_selling", array("month" => $pro->month, "year" => $pro->year, "location_id" => $pro->location_id, "status" => 1));
            ...
            if ($row == 0) {
                $insert = $this->Service_model_13->master_insert("monthly_selling", $data);
            } else {
                $data = $this->Service_model_13->master_update("monthly_selling", array("month" => $pro->month, "year" => $pro->year, "location_id" => $pro->location_id), $data);
            }
        }
		$month = date('m');
        $year = date('Y');
...
//        print_r($update_profit);
    ...
    public function master_add_expense() {
        ...
        if ($token != "") {
            ...
            if ($list) {
                $id = $list[0]['id'];
                $location_id = $list[0]['l_id'];
                $insert = $this->Service_model_13->master_insert("sh_expensein_master_details", array("user_id" => $id, "location_id" => $location_id, "date" => $date2, "data" => $data));
                if ($insert) {
    ...
    function refreshtoken() {
        ...
        if ($new_device_id != '' && $user_id != '') {
            $this->Service_model_13->update("sh_users_device", array("user_id" => $user_id, "device_id" => $old_device_id, "device_type" => $device_type), array("status" => '0'));
            $this->Service_model_13->master_insert("sh_users_device", array("user_id" => $user_id, "device_id" => $new_device_id, "device_type" => $device_type));
    ...
    function logout() {
        ...
        if ($device_id != '' && $user_id != '') {
            $this->Service_model_13->update("sh_users_device", array("user_id" => $user_id, "device_id" => $device_id, "device_type" => $device_type), array("status" => '0'));
    ...
    function testnotfy() {
        $devicelist = $this->Service_model_13->master_fun_get_tbl_val("sh_users_device", array("user_id" => '1', "status" => 1), array("id", "asc"));
        $slidt = array();
        foreach ($devicelist as $d) {
    ...
    public function petty_cash_member_list() {
        ...
        if ($token != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("shusermaster", array("token" => $token, "status" => 1,"Active"=>1), array("id", "id"));
            if ($list) {
                $wallet_list = $this->Service_model_13->master_fun_get_tbl_val("petty_cash_member", array("location_id" => $list[0]['l_id'], "status" => 1), array("name", "asc"));
                if ($wallet_list) {
                    echo str_replace('\"', '"', $this->json_data("1", "", $wallet_list));
                } else {
                    echo $this->json_data("0", "Data Not Available", "");
    ...
    public function petty_cash_transaction() {
        ...
        if ($token != "" && $date != "" && $memberid != "" && $type != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("petty_cash_transaction", $data);
                echo $this->json_data("1", "Your Data submitted successfully", "");
            } else {
                echo $this->json_data("3", "Token expired. Please login again.", "");
            }
    ...
    public function petty_cash_member_list_company() {
        ...
        if ($token != "" & $location != "") {
            $list = $this->Service_model_13->master_fun_get_tbl_val("sh_com_registration", array("token" => $token, "status" => 1), array("id", "id"));
            if ($list) {
                $wallet_list = $this->Service_model_13->master_fun_get_tbl_val("petty_cash_member", array("location_id" => $location, "status" => 1), array("name", "asc"));
                if ($wallet_list) {
                    echo str_replace('\"', '"', $this->json_data("1", "", $wallet_list));
                } else {
                    echo $this->json_data("0", "Data Not Available", "");
    ...
    public function oil_pump_data() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                $id = $list[0]['l_id'];
                $shpump = $this->Service_model_13->master_fun_get_tbl_val("shpump", array("location_id" => $id, "status" => 1, "type" => 'O'), array("id", "id"));
                $location_id = $list[0]['l_id'];
                $oildata = $this->Service_model_13->inventory_detail_for_add($location_id, $date, "o");
//echo $this->db->last_Query();
                $salesdata = $this->Service_model_13->sels_detail_for_add($location_id, $date);
    ...
    function vishal_test() {
        ...
        $devicelist = $this->Service_model_13->master_fun_get_tbl_val("sh_users_device", array("user_id" => '25', "status" => 1), array("id", "asc"));
        $slidt = array();
        foreach ($devicelist as $d) {
    ...
    public function oil_inventory() {
        ...
        if ($token != "" && $oil_inventory != "" && $date != "" && $invoice_no != "" && $oil_cgst != "" && $oil_sgst != "" && $oil_amount != "" && $nett_total != "") {
            ...
            if ($list) {
                ...
                $insert = $this->Service_model_13->master_insert("sh_oil_inventory_data_master", $o_m_data);
                ...
                $insert1 = $this->Service_model_13->master_insert("sh_inventory", $data);
                foreach ($oil_array as $oil_data) {
                    ...
                    $this->Service_model_13->master_insert("sh_oil_inventory_data", $o_data);
                    $data1 = array(
                        "inv_id" => $insert1,
                        ...
                        "ltr" => $oil_data->ltr,
                        "created_at" => date("Y-m-d H:i:s"));
                    $o_insert_id = $this->Service_model_13->master_insert("sh_oil_inventory", $data1);

                    $pdata = $this->Service_model_13->master_fun_get_tbl_val("shpump", array("id" => $oil_data->oil_id, "status" => 1), array("id", "id"));
                    ...
                    $history_data = array('inventory_id' => $o_insert_id,
                        ...
                        'f_reading' => $t_stock);
                    $this->Service_model_13->master_insert("sh_oil_inventory_history", $history_data);
                    $this->Service_model_13->update("shpump", array("id" => $oil_data->oil_id), array("spacket_value" => $oil_data->buyprice,"stock" => $t_stock));
                }
                $shpumpdata = $this->Service_model_13->master_fun_get_tbl_val("shpump", array("location_id" => $location_id, "status" => 1 ,"type" =>'o' ), array("id", "asc"));
                foreach ($shpumpdata as $p) {
                    $pumpdata = $this->Service_model_13->master_fun_get_tbl_val("sh_oil_inventory_data", array("id" => $p->id), array("id", "asc"));
                    if (empty($pumpdata)) {
    ...
    public function oil_pumb_daily_price($date, $qty, $location_id) {
        $list = $this->Service_model_13->master_fun_get_tbl_val("shpump", array("status" => 1, "id" => $pump_id), array("id", "id"));
        //  print_r($list);
        // $history_data = array();
        foreach ($list as $l) {
            if ($l['packet_value'] == "") {
            ...
            $list2 = $this->Service_model_13->master_fun_get_tbl_val("sh_oil_daily_price", array("o_p_id" => $l['id'], "date" => $date), array("id", "id"));
            if (empty($list2)) {
                $data = array("date" => $date,
                    "o_p_id" => $l['id'],
