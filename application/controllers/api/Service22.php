...
class Service22 extends CI_Controller {
    ...
    public function inventory_detail_for_add() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                ...
                $tank = $this->Service_model_15->master_fun_get_tbl_val_with_order('sh_tank_list', array('status' => '1','mobile_show' => '1', 'location_id' => $location_id), array('tank_name', 'asc'));
