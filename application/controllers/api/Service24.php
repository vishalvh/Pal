...
class Service24 extends CI_Controller {
            ...
            if ($list) {
                ...
                if ($checkdata) {
                    ...
                    $data = array(
                        ...
                        'xp_pet_price' => $xp_pet_price,

                        'xp_dis_price' => $xp_dis_price,
		...
		if ($token != "" && $date != "" && $data != "") {
            ...
            if ($list) {
				...
				if($report_submit){
					...
					$nddeate = $date;
					$checkentry = $this->Service_model_15->master_fun_get_tbl_val("sh_daily_tank_density", array("date" => $nddeate, "status" => 1, "location_id" => $location_id), array("id", "asc"));
					if (!$checkentry) {
						echo $this->json_data("0", "Sorry, Please Add Density of : " . date('d-m-Y', strtotime($nddeate)), ""); die();
					}
