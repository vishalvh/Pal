...
class Service17 extends CI_Controller {
    ...
    public function inventory_detail_for_add() {
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
                ...
                $tank = $this->Service_model_15->master_fun_get_tbl_val_with_order('sh_tank_list', array('status' => '1', 'location_id' => $location_id), array('tank_name', 'asc'));
...
//        die();
    ...
    function refreshtoken() {
        ...
        if ($new_device_id != '' && $user_id != '') {
            ...
            $this->Service_model_15->master_insert("sh_users_device", array("user_id" => $user_id, "device_id" => $new_device_id, "device_type" => $device_type));
    ...
    function logout() {
        ...
        if ($device_id != '' && $user_id != '') {
            $this->Service_model_15->update("sh_users_device", array("user_id" => $user_id, "device_id" => $device_id, "device_type" => $device_type), array("status" => '0'));
                ...
                foreach ($oil_array as $oil_data) {
                    ...
                    $o_data = array("p_id" => $oil_data->oil_id,
                        ...
                        "net_total" => $oil_data->nettTotal,
							...
							"newprice"=> ($oil_data->cgst+$oil_data->sgst+$oil_data->nettTotal)/$oil_data->qty
                    );
