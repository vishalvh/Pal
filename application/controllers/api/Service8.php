...
//              $this->email->to($email.',jabir@virtualheight.com');
    ...
    public function all_list() {
        ...
        $data['gst'] = 9;
        $data['oil_benift'] = 5;
        $data['vesion_code'] = $finalarray = array("vesion_code" => "28", "flag" => "TRUE");
...
//                echo $this->db->last_query();
	...
	public function get_user_entry_onlinetransaction(){
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
				$id = $list[0]['id'];
				$sh_onlinetransaction = $this->service_model_8->get_user_entry_onlinetransaction($id,$date);
            ...
            if ($list) {
				...
				if($sh_bankdeposit){
					...
					foreach($sh_bankdeposit as $bankdeposit){
						...
						$bankdeposit['credi_debit'] = $this->service_model_8->bankdeposit_credi_debit($bankdeposit['id']);
	...
	public function get_user_entry_credit_debit(){
        ...
        if ($token != "" && $date != "") {
            ...
            if ($list) {
				$id = $list[0]['id'];
				$credi_debit = $this->service_model_8->date_credi_debit($date,$id);
				if($credi_debit){
