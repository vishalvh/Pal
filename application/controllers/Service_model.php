...
/////////////////////////////////////////////////vishal 11-4 strat
function get_pump_list($type){
        $query = $this->db->query("SELECT id,name,type FROM shpump WHERE status='1' and type='$type' ORDER BY id ASC");
        return $query->result_array();
    }
...
////////////////////////////////////////////////vishal 11-4 end
    ...
    function get_user_list(){
        $query = $this->db->query("SELECT * FROM sh_userdetail WHERE status='1' ORDER BY id ASC");
        return $query->result_array();
    }
