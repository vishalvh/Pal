...
<script src="<?php echo base_url(); ?>plugins/jQuery/jQuery-2.1.4.min.js"></script>
          ...
          <section class="content">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>employee/edit/<?php echo $id;?>" method="post" name="savingdata" onsubmit="return validate()" id="savingdata" enctype="multipart/form-data">
                 <input type="hidden" name="id" value="<?php echo $this->uri->segment('3');?>">
                  <div class="box-body">
					...
					<div class="form-group">
					  ...
					  <option value="<?php echo $companydetail['id'];?>" <?php if($companydetail['id']==$empdetail[0]['company_id']){ echo "selected"; } ?> >
					  <?php } ?>
					  </select>
					...
					<div class="form-group">
					  ...
					  <option value="<?php echo $locationdetail['l_id'];?>" <?php if($locationdetail['l_id']==$empdetail[0]['l_id']){ echo "selected"; } ?> >
					  <?php } ?>
					  </select>
