	    ...
	    <!-- left side start-->
			...
			<!-- //header-ends -->
				<div id="page-wrapper">
									...
									<a href="<?php echo base_url();?>company_worker/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
									</div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('company_worker/ajax_list?extra=')?>",
            "type": "POST"
        },
