	    ...
	    <!-- left side start-->
			...
			<!-- //header-ends -->
				<div id="page-wrapper">
									...
									<h3 class="blank1 pull-left" style="">Customer List</h3>
									<a href="<?php echo base_url();?>manage_customer/add" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add</a>
									</div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('manage_customer/ajax_list?extra=')?>",
            "type": "POST"
        },
