...
//		alert(query);
			$('#table').DataTable({ 
				...
				"ajax": {
					"url": "<?php echo site_url('expense/ajax_list?employeename=')?>"+$Employeename+"&fdate="+$fdate+"&tdate="+$tdate+"&location="+$location,
					"type": "POST"
				},
				"columnDefs": [
				{ 
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('expense/ajax_list?employeename=')?>",
            "type": "POST"
        },
