<?php class Master_model extends CI_Model {
...
//        $this->db->where_not_in('id', $id);
    ...
    function get_active_record(){
        $query = $this->db->query("SELECT * FROM `AdgAdminMmaster` WHERE `status`='1' ORDER BY id ASC");
        return $query->result_array();
    }
    function get_active_record1($one,$two){
       
    $query = $this->db->query("SELECT * FROM `AdgAdminMmaster` WHERE `status`='1' ORDER BY id ASC LIMIT $two,$one ");
...
//		print_r($query->result_array());
	...
	function area_active_record(){
        $query = $this->db->query("SELECT * FROM `AdgFaqs` WHERE `status`='1' ORDER BY id DESC");     
        return $query->result_array();
    }
	...
	function area_active_record1($one,$two){
        $query = $this->db->query("SELECT * FROM `AdgFaqs` WHERE `status`='1' ORDER BY id DESC LIMIT $two,$one ");
        return $query->result_array();
    }
...
$query = $this->db->query("SELECT * FROM `AdgAdminMmaster` WHERE `status`='1'");   
    return $query->result_array();
}
	  function area_list(){
