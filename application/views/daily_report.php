...
$p_p_quantity = $r['p_quantity'];
                                    ...
                                    <tr>
										...
										<?php if($logged_company['type'] == 'c'){ ?>
                                            <a href="<?php echo base_url()?>daily_reports/edit?date=<?php echo date('d-m-Y',strtotime($r['date'])); ?>&location=<?php echo $location; ?>&sdate=<?php echo $this->input->get('sdate'); ?>&edate=<?php echo $this->input->get('edate'); ?>"><?php echo date('d/m/Y',strtotime($r['date'])); ?></a>
										<?php }else{ ?>
...
//											round(($r['p_total_selling']*$r['pet_price']*20)/120,2); 
										...
										<td>
									     ...
									     <?php if($logged_company['type'] == 'c'){ ?>   	<td>
										    <a href="<?php echo base_url()?>daily_reports/edit?date=<?php echo date('d-m-Y',strtotime($r['date'])); ?>&location=<?php echo $location; ?>&sdate=<?php echo $this->input->get('sdate'); ?>&edate=<?php echo $this->input->get('edate'); ?>">View</a>
                                                                             </td> <?php } ?>
                                    </tr>
                                    <?php
$p_dstock = $r['dstock'];
...
//$finaltemptotal = $finaltemptotal +$get_customer_credit->totalamount;
											...
											<tr>
                                                ...
                                                <td>
                                                    <?php echo round($lastday->debit,2);
