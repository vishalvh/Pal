    ...
    <!-- left side start-->
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Add Creditors</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="<?php echo base_url();?>creditors/add" name="savingdata" onsubmit="return validate()">
							<div class="form-group">
									...
									<div class="col-sm-8">
                                                                            <select name="l_id" id="l_id" class="form-control1">
                                                                                ...
                                                                                <option value="<?php echo $loc->l_id; ?>" >  <?php echo $loc->l_name; ?> </option>
                                                                                <?php } ?> 
                                                                            </select>
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="creditorsname" placeholder="Creditors Name" name="creditorsname" value="<?php echo set_value('titile');?>">
