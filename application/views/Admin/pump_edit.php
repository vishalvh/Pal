...
<script src="<?php echo base_url(); ?>plugins/jQuery/jQuery-2.1.4.min.js"></script>
          <section class="content-header">
            ...
            <li><a href="<?php echo base_url(); ?>pumplist_admin"><i class="fa fa-users"></i>Pump List</a></li>
              <li class="active">Edit Pump</li>
            </ol>
          </section>
          <section class="content">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>pumplist_admin/edit/<?php echo $pumpdetail[0]['id'];?>" method="post" name="savingdata" onsubmit="return validate()" id="savingdata" enctype="multipart/form-data">
                 <input type="hidden" name="id" value="<?php echo $pumpdetail[0]['id'];?>">
                  ...
                  <div class="box-body">
					...
					<div class="form-group">
					  ...
					  <option value="<?php echo $companydetail['id'];?>" <?php if($companydetail['id']==$pumpdetail[0]['company_id']){ echo "selected"; } ?> ><?php echo $companydetail['name'];?></option>
					  <?php } ?>
					  </select>
					...
					<div class="form-group">
					  ...
					  <option value="<?php echo $locationdetail['l_id'];?>" <?php if($locationdetail['l_id']==$pumpdetail[0]['location_id']){ echo "selected"; } ?> ><?php echo $locationdetail['l_name'];?></option>
					  <?php } ?>
					  </select>
					...
					<div class="form-group">
                      ...
                      <input type="text" id="name"  name="name" class="form-control" value="<?php echo $pumpdetail[0]['name'];?>" >
					...
					<div class="form-group">
					  ...
					  <option value="p" <?php if('p'==$pumpdetail[0]['type']){ echo "selected"; } ?>>Petrol</option>
					  <option value="d" <?php if('d'==$pumpdetail[0]['type']){ echo "selected"; } ?>>Disel</option>
					  </select>
