                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Employee List</h3>
                            <a style="float:right;" href="<?php echo base_url(); ?>Company_master" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i><strong> Add</strong></a>
...
foreach ($category as $row) {
    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>company_master/view_company/<?php echo $row['id']; ?>"><?php echo ucwords($row['AdminName']); ?></a></td>
                                            <td><?php echo ucwords($row['AdminMNumber']); ?></td>
                                            <td><?php echo ucwords($row['AdminEmail']); ?></td>
																						 <td><?php echo ucwords(($row['AdminGender']=='1')?"Male":"Female"); ?></td>
    ...
    ?></td>
                                            <td>
                                                <a href='<?php echo base_url(); ?>company_master/user_edit/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
