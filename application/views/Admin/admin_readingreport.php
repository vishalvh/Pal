...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Reading Report</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                       <form method="post" action="<?php echo base_url(); ?>admin_readingreport/exportCSV">  
            <br>
           <div class="cal-md-12">
              <div class="col-md-2">
...
//    alert(query);
      $('#table').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo site_url('admin_readingreport/ajax_list?employeename=')?>"+$Employeename+"&fdate="+$fdate+"&tdate="+$tdate+"&location="+$location+"&company="+$company,
          "type": "POST"
        },
        "columnDefs": [
        { 
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin_readingreport/ajax_list?extra=')?>",
            "type": "POST"
        },
