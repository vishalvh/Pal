<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Expensereport info</li>
        </ol>
    </section>
             ...
             <div class="xs tabls">
              <div class="bs-example4" data-example-id="contextual-table" style="display:  inline-block;width: 100%;">
                <div class="col-sm-4">
                  ...
                  <div class="">
                                        <p class="form-control-static" style="margin-left: 55px;margin-top: -32px;"><?php echo date('d-m-Y', strtotime($expense[0]->date));?></p>
                                    </div>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="">
                                        <p class="form-control-static" style="margin-left: 55px;margin-top: -32px;"><?php echo $expense[0]->l_name;?></p>
                                    </div>
                </div>    
                <?php
                  foreach ($expense as $raw) 
                  {
                ?>  
                <div class="col-md-12" style="margin-top: 15px;">
                  ...
                  <label class="control-label"><b>Name</b></label>
                  <div class="">
                                        <p class="form-control-static"><?php echo $raw->name;?></p>
                                    </div>
                                    </div>
                                    <div class="col-md-4">
                                    <label class="control-label"><b>Value</b></label>
                  <div class="">
                                        <p class="form-control-static"><?php echo $raw->value;?></p>
                                    </div>
                                    </div>
                                    <div class="col-md-4">
                                   <label class="control-label"><b>Comment</b></label>
                  <div class="">
                                        <p class="form-control-static"><?php echo $raw->comment;?></p>
                                    </div>
                  </div>
                </div>
