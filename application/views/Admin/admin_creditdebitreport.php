...
<link
    href='<?php echo base_url(); ?>design/css/jquery-ui.min.css'
    rel='stylesheet'
    type='text/css'>
<script
    src='<?php echo base_url(); ?>design/js/jquery-3.0.0.js'
    type='text/javascript'></script>
<script
    src='<?php echo base_url(); ?>design/js/jquery-ui.min.js'
    type='text/javascript'></script>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">credit debit report</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <form method="post" action="<?php echo base_url(); ?>admin_creditdebit/exportCSV">
                            <br>
                            <div class="cal-md-12">
                                <div class="col-md-2">
                                    ...
                                    <input
                                        ...
                                        value="<?php if(isset($date1) != NULL){ echo $date1; } ?>"/>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input
                                        ...
                                        value="<?php if(isset($date2) != NULL){ echo $date2; } ?>"/>
                ...
                foreach ($location as $raw) 
                {
                  ?>
                                        ...
                                        <option
                                            ...
                                            <?php if(isset($location) != NULL) { if($id == $location) { echo "selected"; } } ?>><?php echo $raw['l_name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                ...
                foreach ($Employee as $row) 
                {
                  ?>
                                        <option
                                            value="<?php $id = $row['id']; echo $row['id']; ?>"
                                            <?php if(isset($Employeename) != NULL) { if($id == $Employeename ) { echo "selected"; } } ?>><?php echo $row['UserFName']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
...
<script type="text/javascript">
    ...
    function search(query) {
        ...
        $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin_creditdebit/ajax_list?employeename=')?>" +
                        $Employeename + "&fdate=" + $fdate + "&tdate=" + $tdate + "&location=" +
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin_creditdebit/ajax_list?extra=')?>",
                "type": "POST"
            },
            ...
            if (lid == 0) {
                $.ajax({
                    ...
                    success: function (response) {
                        var obj = JSON.parse(response);
                        $("#Employeename").empty();
                        $("#Employeename").append($('<option>Select Employee</option>'));
                        for (var i = 0; i < obj.length; i++) {
                            $("#Employeename").append($(
                                '<option value=' + obj[i].id + '>' + obj[i].UserFName + '</option>'
                            ));
