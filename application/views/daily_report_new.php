...
<div class="main-content">
    ...
    <div id="page-wrapper">
                ...
                <form class="form-horizontal" method="get" action="" name="savingdata" >
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-2">
                            <select name="location" id="location" class="form-control1">
                                ...
                                foreach ($location_list->result() as $row) {
                                    ?>
                                    <option value="<?php echo $row->l_id; ?>" <?php
                                    if ($location == $row->l_id) {
                                        echo "selected";
                                    }
                        ...
                        <div class="col-sm-2">
                            ...
                            <button class="btn btn-primary" formtarget="_blank"  onClick="Submitdata();" type="submit" >Print</button>
                        </div>
                        <div class="col-sm-4">
                        </div>
                        <hr>
        ...
        <?php if ($logged_company['type'] == 'c') { ?>
                                                <a href="<?php echo base_url() ?>daily_reports_new/edit?date=<?php echo date('d-m-Y', strtotime($r['date'])); ?>&location=<?php echo $location; ?>&sdate=<?php echo $this->input->get('sdate'); ?>&edate=<?php echo $this->input->get('edate'); ?>"><?php echo date('d/m/Y', strtotime($r['date'])); ?></a>
                                            <?php } else { ?>
                                        ...
                                        <td nowrap>
        <?php
        if (isset($finaltank[$r['date']][$r['id']]['d'])) {
            foreach ($finaltank[$r['date']][$r['id']]['d'] as $tankd) {
                echo $tankd['name'] . " : " . $tankd['deepreading'];
                echo "<br>";
            }
        }
        ?>
                                        ...
                                        <td>
                                            <?php
                                            echo round($r['d_total_selling'] * $r['d_new_price'], 2);
                                            //echo "(".$r['d_new_price'].")"; 
        ...
        ?>
                                        ...
                                        <td nowrap>
        <?php
        if (isset($finaltank[$r['date']][$r['id']]['p'])) {
        ...
        ?>
                                        ...
                                        <td>
                                            <?php
                                            echo round(($r['p_total_selling'] * $r['pet_price']) - ($r['p_total_selling'] * $r['p_new_price']), 2);
...
//											round(($r['p_total_selling']*$r['pet_price']*20)/120,2); 
                                        ...
                                        <td>
                                            <?php echo round(($r['p_total_selling'] * $r['pet_price'] * 20) / 120, 2);
                                            $ptotaldsellingvat = $ptotaldsellingvat + round(($r['p_total_selling'] * $r['pet_price'] * 20) / 120, 2);
                                            ?>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <?php echo round($PETEV * $r['pet_price'], 2);
                                            $pevprice = $pevprice + ($PETEV * $r['pet_price']);
                                            ?>
                                        </td>
                                        <td>
        <?php echo round($r['ostok'], 2); ?> 
                                        ...
                                        <td>
                                            <?php echo round($r['oil_reading'], 2);
                                            $oil_reading = $oil_reading + $r['oil_reading'];
                                            ?>
                                        </td>
                                        <td>
        <?php echo round($r['oil_pure_benefit'], 2);
        $oil_pure_benefit = $oil_pure_benefit + $r['oil_pure_benefit'];
        ?>
                                        </td>
                                        <td>
        ...
        ?>
                                        ...
                                        <td>
                                    <?php echo round((($r['oil_reading'] * 18) / 118), 2);
                                    $oil_sgst = $oil_sgst + round((($r['oil_reading'] * 18) / 118), 2);
                                    ?>
                                        </td>
                                                                                <!--<td>
        ...
        ?>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($logged_company['type'] == 'c') { ?>   	<td>
                                                <a href="<?php echo base_url() ?>daily_reports_new/edit?date=<?php echo date('d-m-Y', strtotime($r['date'])); ?>&location=<?php echo $location; ?>&sdate=<?php echo $this->input->get('sdate'); ?>&edate=<?php echo $this->input->get('edate'); ?>">View</a>
                                            </td> <?php } ?>
                                    </tr>
                                            <?php
                                            $p_dstock = $r['dstock'];
...
//$bank_balence = ($deposit_amount->cash_total)-($deposit_amount->cheque_total+$onlinetransaction->total_onlinetransaction);
                                            echo $bank_balence = round((($deposit_amount->cash_total + $deposit_amount->cheque_total + round($totalcard_fule, 2) + ($pre_deposit_amount->cash_total + $pre_deposit_amount->cheque_total + round($prev_card_depost, 2))) - ($onlinetransaction->total_onlinetransaction)) - ($pre_onlinetransaction->total_onlinetransaction), 2);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            //echo round($lastday->ioc_amount,2);
...
<script>
                                ...
                                function SubmitForm()
                                {
                                    ...
                                    document.forms['savingdata'].action = '<?php echo base_url(); ?>daily_reports_new/index';
                                    document.forms['savingdata'].submit();
