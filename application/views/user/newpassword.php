        ...
        <div class="wrapper">
			...
			<section class="section-checkout">
                <div class="container">
						...
						<form action="<?php echo base_url(); ?>registration/resetp" class="form-padding col-md-offset-1 col-md-10"
						method="post">
                                   <div class="control-group">
                                       ...
                                       <?php  if(isset($success) && $success!=""){
                                        ...
                                        <div class="controls inpadding">
                                            ...
                                            <input id="password" type="password"  name="UserPassword" class="required col-lg-12 col-md-12 col-sm-12 col-xs-12 cusmo-input" value="<?php echo set_value('UserPassword'); ?>"  />
                                            <?php echo form_error('UserPassword', '<div class="error" style="color:red;">', '</div>'); ?> 
										
                                        </div>
                                    </div>
                                     <input type="hidden"  name="id" value="<?php echo $id ?>"/>
                                    <div class="button-holder btnlogin col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center btn-mar">
                                    <button class="cusmo-btn narrow " type="submit" >set new</button>
                                    </div>
                        </form>
						</div>
						</div>
