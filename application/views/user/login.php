                    ...
                    <div class="mainlogin">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <form action="<?php echo base_url(); ?>Login/verify_login" class="form-padding col-md-offset-1 col-md-10"
                                      method="post">
                                    <div class="control-group">
                                        ...
                                        <div class="controls inpadding">
                                            ...
                                            <input type="text" id="email"   name="email"  class="required col-lg-12 col-md-12 col-sm-12 col-xs-12 cusmo-input"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls inpadding">
                                            ...
                                            <input id="password" type="password"  name="password" class="required col-lg-12 col-md-12 col-sm-12 col-xs-12 cusmo-input"  />
...
<?php echo form_error('password', '<div class="error" style="color:red;">', '</div>'); ?>
                                    ...
                                    <div class="forget-password">
                                        <a href="<?php echo base_url(); ?>registration/Forgot_password">Forgot your password?</a>
                                    </div>
