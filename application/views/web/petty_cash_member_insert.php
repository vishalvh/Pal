				...
				<div class="graphs">
					<h3 class="blank1">Petty Cash Member</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="<?php echo base_url();?>petty_cash_member/insert" name="savingdata" onsubmit="return validate()">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="mobile" class="form-control" name="mobile" placeholder="Mobile" value="" />
