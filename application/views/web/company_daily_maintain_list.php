...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        <div class="page-header">
            <h3 class="blank1 pull-left" style="">Expense List</h3>
            <?php if(in_array("daily_maintain_add",$this->data['user_permission_list'])){ ?>
			<a href="<?php echo base_url(); ?>company_daily_maintain/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
			<?php } ?>
        </div>
                ...
                <table class="table" id="table">
                    <thead>
                        <tr>
                            ...
                            <th>Name</th>
                            <th>Status</th>
<?php if(in_array("daily_maintain_action",$this->data['user_permission_list'])){ ?>
<th>Action</th>
<?php } ?>
                        </tr>
                    </thead>
...
<script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        table = $('#table').DataTable({
                            ...
                            "ajax": {
                                "url": "<?php echo site_url('company_daily_maintain/ajax_list?extra=') ?>" + $lid,
                                "type": "POST"
                            },
