...
<!-- header-starts -->
	...
	<div id="page-wrapper">
		<div class="page-header">
			<h3 class="blank1 pull-left" style="">Reset pump List</h3>
			<?php if(in_array("reset_pump_add",$this->data['user_permission_list'])){ ?>
			<a href="<?php echo base_url();?>reset_pump/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
			<?php } ?>
		</div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('reset_pump/ajax_list?extra=')?>",
            "type": "POST"
        },
...
//                                                                alert($lid);
                        ...
                        $('#table').DataTable({
                            ...
                            "ajax": {
                                "url": "<?php echo site_url('reset_pump/ajax_list?extra=')?>" + $lid,
                                "type": "POST"
                            },
                            "columnDefs": [
                                {
