...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="page-header">
            <h3 class="blank1 pull-left" style="">Wallet List</h3>
            <?php if(in_array("wallet_add",$this->data['user_permission_list'])){ ?>
                <a href="<?php echo base_url(); ?>wallet/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
            <?php } ?>
        </div>
                ...
                <table class="table" id="table">
                    <thead>
                        <tr>
                            ...
                            <th>Tank Location</th>
                              <th>Status</th>
                            <?php if(in_array("wallet_action",$this->data['user_permission_list'])){ ?><th>Action</th> <?php } ?>
                        </tr>
                    </thead>
                    <tbody>
...
<script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        table = $('#table').DataTable({
                            ...
                            "bInfo": false,
                            "ajax": {
                                "url": "<?php echo site_url('wallet/ajax_list?extra=') ?>"+$lid,
                                "type": "POST"
                            },
                            "columnDefs": [
                                {
