...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        <div class="page-header">
            ...
            <?php if(in_array("expense_add",$this->data['user_permission_list'])){ ?>
			<a href="<?php echo base_url(); ?>company_expense/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
			<?php } ?>
        </div>
...
<script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        table = $('#table').DataTable({
                            ...
                            "ajax": {
                                "url": "<?php echo site_url('company_expense/ajax_list?extra=') ?>" + $lid,
                                "type": "POST"
                            },
