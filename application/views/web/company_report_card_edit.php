...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        <?php } ?>
        <div class="md tabls">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>company_report/card_deposit_edit/<?php echo $id; ?>" name="savingdata" onsubmit="return validate()">
                <div class="bs-example4" data-example-id="contextual-table" style="display:  inline-block;width: 100%;">
                            ...
                            <div class="col-md-12" > 
                                    <div class="col-md-4">
                                        <label class="control-label"><b style="float:left;text-align:left;">Batch No</b></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input  id="batch_no" type="text" class="form-control1 "  placeholder="Batch No" name="batch_no" value="<?php echo $detail->batch_no; ?>">
