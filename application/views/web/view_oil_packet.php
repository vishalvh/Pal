...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        <div class="page-header">
            ...
            <?php if(in_array("oil_packet_add",$this->data['user_permission_list'])){ ?>
			<a href="<?php echo base_url(); ?>oil_packet/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
			<?php } ?>
			<?php if(in_array("oil_packet_view_stock",$this->data['user_permission_list'])){ ?>
            <a style=" margin-right: 8px;" href="<?php echo base_url(); ?>oil_packet/view_stock" class="btn btn-primary pull-right" style="">View stock </a>
            <?php } ?>
			<?php if(in_array("oil_packet_set_order",$this->data['user_permission_list'])){ ?>
			<a style=" margin-right: 8px;" href="<?php echo base_url(); ?>oil_packet/set_order_stock" class="btn btn-primary pull-right" style="">Set order </a>
			<?php } ?>
        </div>
                ...
                <table class="table" id="table">
                    <thead>
                        <tr>
                            ...
                            <th>Buy Price</th>
                            <th>Status</th>
                            <?php if(in_array("oil_packet_action",$this->data['user_permission_list'])){ ?>
							<th>Action</th>
							<?php } ?>
                        </tr>
                    </thead>
...
$lid = $('#location').val();
                        ...
                        table = $('#table').DataTable({
                            ...
                            "ajax": {
                                "url": "<?php echo site_url('oil_packet/ajax_list?extra=') ?>"+$lid,
                                "type": "POST"
                            },
