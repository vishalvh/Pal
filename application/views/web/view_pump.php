...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        <div class="page-header">
            <h3 class="blank1 pull-left" style="">Pump List</h3>
            <?php if(in_array("pump_add",$this->data['user_permission_list'])){ ?>
			<a href="<?php echo base_url(); ?>Admin_pump/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
			<?php } ?>
                ...
                <table class="table" id="table">
                    <thead>
                        <tr>
                            ...
                            <th>Nozzel Code</th>
                            <th>Status</th>
                            <?php if(in_array("pump_action",$this->data['user_permission_list'])){ ?>
							<th>Action</th>
							<?php } ?>
                        </tr>
                    </thead>
...
$lid = $('#location').val();
                        ...
                        table = $('#table').DataTable({
                            ...
                            "ajax": {
                                "url": "<?php echo site_url('Admin_pump/ajax_list?extra=') ?>"+$lid,
                                "type": "POST"
                            },
