...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <form method="post" action="<?php echo base_url(); ?>admin/add">			
            <h3 class="blank1" style="margin-top: -20px;">Saving Member Info</h3>
        </form>
        <h3 class="blank1"></h3>
        <br>
        ...
        <?php } ?>
        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>saving_member_report/info?id=<?php echo $this->input->get('id'); ?>&sdate=<?php echo $this->input->get('sdate'); ?>&edate=<?php echo $this->input->get('edate'); ?>&l_id=<?php echo $this->input->get('l_id'); ?>&member_id=<?php echo $this->input->get('member_id'); ?>" name="savingdata" onsubmit="return validate()" enctype="multipart/form-data">
            <div class="md tabls">
                <div class="bs-example4" data-example-id="contextual-table" style="display:  inline-block;width: 100%;">
                    <div class="col-md-4">
                        ...
                        <div class="">
                            ...
                            <input type="text" id="start_date"  readonly class="form-control start_date" name="date" placeholder="Date" value="<?php echo date('d-m-Y', strtotime($transaction_detail->date)); ?>" />
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <select id="memberid" name="memberid" class="form-control">
                                ...
                                <option value="<?php echo $type->id ?>" <?php if ($transaction_detail->member_id == $type->id) echo"selected" ?>><?php echo ucfirst($type->name); ?></option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="text" class="form-control" name="amount" id="amount" placeholder="Amount" value="<?php echo $transaction_detail->amount; ?>" />
...
<!--                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="text" class="form-control" name="remark" id="reson" placeholder="Remark" value="<?php echo $transaction_detail->remark; ?>" />
