...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <form method="post" action="<?php echo base_url(); ?>admin/add">			
            <h3 class="blank1" style="margin-top: -20px;">Company Credit Debit Edit</h3>
        </form>
        <h3 class="blank1"></h3>
        <br>
        ...
        <?php } ?>
        <div class="md tabls">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>company_report/edit_credit_debit?id=<?php echo $id; ?>&sdate=<?php echo $this->input->get('sdate');?>&edate=<?php echo $this->input->get('edate');?>" name="savingdata" onsubmit="return validate()">
