...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Saving Member</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="<?php echo base_url();?>saving_member/update/<?php echo $id;?>/<?php  echo $this->uri->segment('4'); ?>" name="savingdata" onsubmit="return validate()">
