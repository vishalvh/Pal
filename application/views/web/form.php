...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        <div class="page-header">
            <h3 class="blank1 pull-left" style="">Employee List</h3>
            <?php if(in_array("employee_add",$this->data['user_permission_list'])){ ?>
			<a href="<?php echo base_url(); ?>admin/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
			<?php } ?>
        </div>
                ...
                <table class="table" id="table">
                    <thead>
                        <tr>
                            ...
                            <th>Location</th>
                            <th>Shift</th>
                            <?php if(in_array("employee_action",$this->data['user_permission_list'])){ ?>
							<th>Action</th>
							<?php } ?>
                        </tr>
                    </thead>
...
<script type="text/javascript">
 ...
 $lid = $('#location').val();
                                                                 ...
                                                                 table = $('#table').DataTable({
                                                                     ...
                                                                     "ajax": {
                                                                         "url": "<?php echo site_url('admin/ajax_list?extra=') ?>"+$lid,
                                                                         "type": "POST"
                                                                     },
