...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <form method="post" action="<?php echo base_url(); ?>admin/add">			
            <h3 class="blank1" style="margin-top: -20px;">Card Edit</h3>
        </form>
        <h3 class="blank1"></h3>
        <br>
        ...
        <?php } ?>
        <div class="md tabls">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>company_report/company_credit_by_customer_edit?id=<?php echo $id; ?>&sdate=<?php echo $sdate; ?>&edate=<?php echo $edate; ?>" name="savingdata" onsubmit="return validate()">
                <div class="bs-example4" data-example-id="contextual-table" style="display:  inline-block;width: 100%;">
							...
							<div class="col-md-12">
								...
								<div class="col-sm-8">
									<select class="form-control1 " id="customerid" name="coustomerid">
										<option value="">Select Customer</option>
				<?php $html = "";						foreach ($customerlist as $customer){

				$selected = "";
				
				if($detail->customer_id == $customer->id) { $selected = "selected"; }
...
function validate() {
	...
	if (batch_no == "") {
		$("#chequeerror").html("Batch No is required.");
		temp++;
	}
	if (temp != 0) {
		return false;
