                ...
                <form class="form-horizontal" method="get" action="" name="savingdata" >
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-4">
							...
							<a href="<?php echo base_url();?>/daily_reports_new_jun/index?sdate=<?php echo date("d-m-Y", strtotime($sdate)); ?>&edate=<?php echo date("d-m-Y", strtotime($edate)); ?>&location=<?php echo $location; ?>&debug=1" target="_blank"> Beta Report for XP</a>
							<?php } ?>
    ...
    if ($locationtank->fuel_type == 'p' && $locationtank->xp_type != 'Yes') { ?>
        ...
        $d_testing = $d_testing + $r['d_testing']; ?>
                                        ...
                                        <td>
                                            <span data-toggle="tooltip" title="<?=date('d/m/Y', strtotime($r['date']))?>">
        <?php
		//echo $r['d_total_selling'] ."*". $r['dis_price']."<br>";
        ...
        ?>
                                        ...
                                        <td>
                                            <span data-toggle="tooltip" title="<?=date('d/m/Y', strtotime($r['date']))?>">
                                            <?php
//echo "(".$r['d_total_selling'] ."*". $r['dis_price'].") - (".$r['d_total_selling'] ."*". $r['d_new_price'].") - ".$r['expence']."<br>";
											echo amountfun(($r['d_total_selling'] * $r['dis_price']) - ($r['d_total_selling'] * $r['d_new_price']) - $r['expence']);
