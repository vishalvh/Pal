...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        ?>
        <div class="md tabls">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>bank_deposit/bankdeposit_edit?id=<?php echo $id; ?>&sdate=<?php echo $this->input->get('sdate');?>&edate=<?php echo $this->input->get('edate');?>&l_id=<?php echo $this->input->get('l_id');?>" name="savingdata" onsubmit="return validate()">
			<div class="clo-md-12">
