...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Petty Cash Member</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="<?php echo base_url();?>petty_cash_member/update/<?php echo $id;?>/<?php  echo $this->uri->segment('4'); ?>" name="savingdata" onsubmit="return validate()">
								...
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">Mobile</label>
									<div class="col-sm-8">
										<input type="text" id="mobile" class="form-control" name="mobile" placeholder="Mobile" value="<?php echo $petty_cash_member[0]->mobile; ?>" />
										<div class="invalid-feedback" id="mobileerror" style="color: red;"></div></div>
								</div>
								<div class="form-group">
