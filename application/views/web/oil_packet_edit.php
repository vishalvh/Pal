				...
				<div class="graphs">
					<h3 class="blank1">Edit Oil Packet Detail</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="<?php echo base_url();?>Oil_packet/upd_packet/<?php echo $id;?>/<?php echo $this->uri->segment(4);?>" name="savingdata" onsubmit="return validate()">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="packet_qty" placeholder="Oil packet quantity" name="packet_qty" value="<?php echo $pump[0]->new_p_qty; ?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="packet_value" placeholder="Oil packet buy price" name="packet_value" value="<?php echo $pump[0]->packet_value; ?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="spacket_value" placeholder="Oil packet sell price" name="spacket_value" value="<?php echo $pump[0]->spacket_value; ?>">
										<?php echo form_error('packet_value' ,'<div class="error" style="color:red;padding-bottom: 0px;padding-top: 0px;">','</div>');?>
