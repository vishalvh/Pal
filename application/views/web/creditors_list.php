...
<div class="main-content">
    ...
    <div id="page-wrapper">
        ...
        <div class="page-header">
            <h3 class="blank1 pull-left" style="">Creditors List</h3>
            <?php if(in_array("creditors_add",$this->data['user_permission_list'])){ ?>
			<a href="<?php echo base_url(); ?>creditors/add" class="btn btn-primary pull-right" style=""><i class="fa fa-plus"></i> Add</a>
			<?php } ?>
        </div>
                ...
                <table class="table" id="table">
                    <thead>
                        <tr>
                            ...
                            <th>Name</th>
                            <th>Status</th>
<?php if(in_array("creditors_action",$this->data['user_permission_list'])){ ?>
<th>Action</th> <?php } ?>
                        </tr>
                    </thead>
                    <tbody>
...
<script type="text/javascript">
    ...
    "processing": true, //Feature control the processing indicator.
            ...
            "ajax": {
            "url": "<?php echo site_url('creditors/ajax_list?extra=') ?>"+$lid,
                    "type": "POST"
            },
