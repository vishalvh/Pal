		...
		<div class="main-content">
			...
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Add Tank</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="<?php echo base_url();?>tank_list/add_tank" name="savingdata" onsubmit="return validate()">
								<input type="hidden" name="id" value="<?php echo $this->uri->segment(3);?>">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Tank Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="tank_name" placeholder="Tank Name" name="tank_name" value=""><?php echo form_error('tank_name','<div class="error" style="color:red;padding-bottom: 0px;padding-top: 0px;">','</div>' );?>
